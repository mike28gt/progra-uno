 ...
 */
public class Catedratico extends MiembroUniversidad implements AsignarCursos, GenerarIdentificacion {
    ...
    public String toString() {
        return "Código de Catedrático: " + super.getIdentificacion() + 
    ...
    public void generarIdInterno() {
        System.out.println("Catedratico Generar Identificador Interno");
    }
